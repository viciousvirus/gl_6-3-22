...
-Si claramente hay una sugerencia mala votada positivamente no lo haremos. Todo es posible pero algunas requieren más trabajo que otras.
...
-Será permitido en Puffin o otros navegadores que tengan flash, pero podría tener bajo rendimiento por limitaciones de software.

4. ¿Cuanto seguro estás en tu habilidad para programar el juego?
...
10. Marido ya no es parte del proyecto, ¿Pero qué pasará con el sitio web que tenía?
...
15. ¿Estás buscando partner con otros juegos y youtubers?
-Si. He sido contactado por alguien preguntando por partner y tenía 2 suscriptores. Estamos buscando el partnership pero no sabemos quien sigue estando. Por favor contactanos si está interesado. Al estar en Steam esencialmente somos Steam partner. Esperamos también el partner en Discord pero es un poco nuevo el servidor aún.
...
-Phoenix Launcher y Steam. Puede algo como Epic Games. Epic Games requiere que sea lanzado primero en Steam.
...
21. Acerca de batallas de jefes, la última vez esperé 2 horas y media múltiples veces, ¿Estaban trabajando en ello?
...
-Probablemente haremos aplicaciones beta tester otra vez, y si.

23. ¿Añadir más edificios hará el juego más lento?
-Tenemos unos edificios ya planeados como el de alianza. Tenemos también planes para nuevos edificios que nunca fueron lanzados en Galaxy Life. Como edificios que den soporte a otros jugadores con guerras de puntos o algo similar. Como ejemplo, puedes ir basado en el nivel de la alianza para mejores recompensas. Como también usarlo para poner tropas que se puedan usar por otros jugadores y también decoraciones.

24. ¿Es como un segundo búnker de amigos entonces?
-No es para defensa cuando eres atacado. Es usado para tus propios ataques, usando esas unidades que alguien dona.

25. ¿Cuántas visitas un streamer necesita para el partner?
-Esperamos que tenga un crecimiento básico en la comunidad, algunas personas que mirán mucho tu contenido. Es difícil poner un número. Si tienes una comunidad activa y hablas con la gente y haces un video almenos una vez a la semana, es un buen punto de partida. No es cuantas visitas tengas, más en qué tipo de streamer eres, tu personalidad. Acercate a nosotros y te responderemos.
...
29. Las s-trikes eran muy potentes, ¿Su meta cambiará?
-Por supuesto. Cambios de balance y otros cambios. Es intencional que el nivel 7 de las s-trike sean fuertes pero cuando la gente llegue a ese punto miraremos a los resultados.
...
35. ¿Considerarías hacer una encuesta en reiniciar el progreso ahora antes del lanzamiento, en el caso de que los jugadores quieran un reinicio es entonces innecesario recuperar el progreso antiguo?
...
-Habrá opciones para cambiar el idioma pero no estoy seguro si todos los archivos de idiomas son completos. En 2019 con los assets de Marido puede que hayan tenido archivos desactualizados. El idioma estándar será el Inglés.
...
38. ¿El chat y la academia serán implementadas?
-Si, con una implementación en Steam o Discord.

39. ¿Hay algún lugar para descargar imagenes de los assets para dibujar?
-Si sabes el cdn puedes descargarlos desde ahi. Ahora mismo no tenemos un lugar donde puedas solamente obtenerlos pero puede que en el futuro.
...
41. He visto en la wiki con bastantes imagenes pero no el suelo de los edificios.
-Los suelos de los edificios están en los archivos .swf. Podría extraerlos para tí si quieres.

42. ¿Qué sistema de puntos de guerra conseguidos para medallas y conseguido por bases destruidas será en el lanzammiento? En el antiguo Galaxy Life como es actualmente en el servidor de pruebas(110.000 para la medalla s-trike) o como en Galaxy Life Reborn(1.000.000)?
-El antiguo de Galaxy Life.

43. Si se necesitase que la comunidad cambiase, considerarías cambiarla?
-Si.
